...
// Funcion que activa el overlay. Se pasa como parametro el contenedor padre (#vintalight en el DOM)
var activeVintalight = function activeVintalight(container) {
    // Delegacion de eventos para detectar click en los hijos
    container.addEventListener("click", function (e) {
        var element = e.target;
        // Validar que se haya dado click en el pseudoelemento before
        if (element.tagName == "DIV") {
            // Obtener direccion y descripcion de la imagen que se dio click
            var src = element.querySelector("img").getAttribute("src"),
                descrip = element.querySelector("img").getAttribute("alt"),

            // Crear un nuevo div que se usara como overlay
            ...
            // Anadimos la clase active para poder darle transicion
            setTimeout(function () {
